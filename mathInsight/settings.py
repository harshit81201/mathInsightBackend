...
ALLOWED_HOSTS = env.list('ALLOWED_HOSTS', default=['localhost', '127.0.0.1', '0.0.0.0','healthcheck.railway.app','mathinsightbackend-production.up.railway.app','*.railway.app'])
...
STATICFILES_DIRS = [
    # BASE_DIR / 'static',  # Uncomment if you create a static directory
]
